...
const zh: LANG_MESSAGE = {
  ...
  testUrlLabel: '测速地址',
  testUrlDescription: '自动择优(url-test)组和代理页的延迟测试用这两个地址;每个自动择优组还可以在出口管理里单独指定。',
  ...
  trafficOtherHint: '面板每 2 秒读一次内核的连接表,存活不到一个采样周期的连接归不到出口/域名,只计入当天总量',
  trafficEmptyDay: '这天没有流量记录',
  trafficMoreRows: '还有 {n} 条没显示,输入关键字缩小范围',
  trafficPickDay: '点一根柱子看这天按终端设备、出口、访问目标的明细',
