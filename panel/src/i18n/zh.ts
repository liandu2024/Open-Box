...
const zh: LANG_MESSAGE = {
  ...
  backupTitle: '导出与导入',
  backupDescription: '把这台路由器上配好的东西打成一个文件:目标分流、站点集、节点组、终端分流、共享网络、DNS、更新计划等,可选带上订阅和节点。新设备导入后免配置。',
  backupIncludeSubscriptions: '包含订阅和节点',
  backupExport: '导出',
  backupExportHint: '不含面板密码;面板外观等浏览器端设置在「面板设置」里另导。',
  backupImport: '导入',
  backupImportHint: '选一个导出的 .json 文件;导入后重启内核生效。',
