...
const zh: LANG_MESSAGE = {
  ...
  routingPolicyDefaultLabel: '默认走',
  routingPolicyDefaultHint: '首次部署时选中的线路,之后可以在「代理」页随时改。',
  ...
  routingPolicyConditionHint: '用英文逗号分隔;同一条策略里几类条件是「或」的关系,命中任一条即算命中。',
  ...
  routingRegionAddTitle: '添加地区',
  routingRegionEditTitle: '编辑地区',
  ...
  kernelDeployStateGoToRouting: '前往分流设置',
