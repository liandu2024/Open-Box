...
const zh: LANG_MESSAGE = {
  ...
  routingPoliciesDescription: '一个站点集 = 一组匹配规则。命中的流量走这个站点集选中的线路(在「代理」页选)。按顺序匹配,可以拖拽调整;站点集优先于「分流」页的地区规则。',
  routingPoliciesEmpty: '还没有站点集。没有站点集时,全部流量按「分流」页的地区规则走。',
