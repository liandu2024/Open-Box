...
const zh: LANG_MESSAGE = {
  ...
  routingRegionRulesetsLabel: '规则集',
  routingRegionRulesetsPlaceholder: 'geosite-cn,geoip-cn',
  routingRegionRulesetsHint: '英文逗号分隔。留空表示这个地区没有特殊规则,全部流量按下面的「其余流量」走。',
  routingRegionTargetLabel: '规则集走',
  routingRegionFallbackLabel: '其余流量走',
  routingRegionViaProxy: '代理',
  routingRegionSummary: '{rulesets} → {target},其余 → {fallback}',
