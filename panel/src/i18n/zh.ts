...
const zh: LANG_MESSAGE = {
  ...
  testUrlLabel: '测速地址',
  testUrlDescription: '自动择优(url-test)组和代理页的延迟测试用这两个地址;每个自动择优组还可以在出口节点里单独指定。',
  trafficRetentionTitle: '分析数据保留时长',
  trafficRetentionDescription: '每日流量的曲线、排行,以及点开后的构成明细,在路由器上存多久。超期的记录每分钟清理一次。',
  trafficRetentionUnit: '个月',
  trafficRetentionRange: '1 ~ 36,默认 6',
  ...
  trafficOtherHint: '面板每 2 秒读一次内核的连接表,存活不到一个采样周期的连接归不到出口节点/域名,只计入当天总量',
  trafficEmptyDay: '这天没有流量记录',
  trafficMoreRows: '还有 {n} 条没显示,输入关键字缩小范围',
  trafficPickDay: '点一根柱子看这天按终端设备、出口节点、访问目标的明细',
