...
const zh: LANG_MESSAGE = {
  ...
  routingCategoryDeleteTitle: '删除分流规则',
  routingCategoryDeleteConfirm: '确定删除「{name}」这条分流规则?删掉后它会跟着后面的兜底规则走。',
  ...
  routingRegionCn: '中国大陆',
  routingRegionCnHint: '中国网站与 IP 直连(不经过 Open-Box),其余走代理。',
  routingRegionHkmo: '香港澳门',
  routingRegionHkmoHint: '只有下面的策略走代理,其余全部直连。',
  routingRegionOther: '其他地区',
  routingRegionOtherHint: '中国网站与 IP 走代理(回国),其余直连。',
  routingRegionDirectNote: '走直连的流量和它的 DNS 都不经过 Open-Box,直接走路由器原来的线路。',
  ...
  dnsDirectSystemNote: '直连域名交给系统解析(路由器原有的 DNS),不经过 Open-Box。',
  ...
  routingRegionDescription: '路由器本身在哪。它决定没被下面的策略挑走的流量往哪走。',
