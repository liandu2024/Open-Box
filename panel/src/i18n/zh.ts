...
const zh: LANG_MESSAGE = {
  ...
  routingOutboundsEmpty: '一个都没开,策略只能走直连。',
  routingOutboundReject: '拒绝',
  routingRegionDirectNote: '走直连的流量和它的 DNS 都不经过 Open-Box,直接走路由器原来的线路;走代理的域名,由该策略选中的节点解析。',
  routingPoliciesTitle: '策略分流',
  routingPoliciesDescription: '命中策略的流量走该策略选中的线路。策略按顺序匹配,可以拖拽调整;策略优先于上面的地区规则。',
  routingPoliciesEmpty: '还没有策略。没有策略时,全部流量按上面的地区规则走。',
  routingPolicyAdd: '添加策略',
  routingPolicyAddTitle: '添加策略',
  routingPolicyEditTitle: '修改策略',
  routingPolicyNameLabel: '策略名称',
  routingPolicyRulesLabel: '规则',
  routingPolicyRuleAdd: '添加规则',
  routingPolicyNoRuleYet: '还没有规则。至少加一条,否则这条策略不会命中任何流量。',
  ...
  routingPolicyNameRequired: '请填写策略名称。',
  routingPolicyNameDuplicate: '已有同名策略;策略名会直接用作内核里的出站名称,不能重复。',
  ...
  routingPolicyConditionRequired: '至少要填一类匹配条件,否则这条策略永远不会命中。',
  routingPolicyNoCondition: '没有匹配条件',
  routingPolicyDeleteTitle: '删除策略',
  routingPolicyDeleteConfirm: '确定删除策略「{name}」?内核里那个同名选择器会一起消失,「代理」页上也就没有它了。',
  ...
  // --- 地区默认值卡片 ---
  routingRegionTitle: '地区分流',
  edit: '编辑',
  routingRegionAdd: '添加地区',
  routingRuleActionHeader: '动作',
  routingRuleValueHeader: '规则值',
  routingRuleTypeHeader: '类型',
  routingRegionSummaryRules: '{count} 条规则,其余 → {fallback}',
  routingRegionNoRules: '还没有规则。全部流量按下面的「其余流量」走。',
  routingRegionRuleAdd: '添加规则',
  routingRegionRulesLabel: '规则',
  routingRegionSettingsTitle: '「{name}」的分流设置',
  routingRegionNewName: '新地区',
  routingRegionNameLabel: '名称',
  routingRegionNamePlaceholder: '比如:日本',
  routingRegionNameRequired: '先给这条地区起个名字。',
  routingRegionFallbackLabel: '其余流量',
  routingRegionViaProxy: '代理',
  routingRegionSummaryAll: '全部流量 → {fallback}',
  routingRegionDeleteTitle: '删除地区',
  routingRegionDeleteConfirm: '确定删除「{name}」吗?',
  routingRegionDeleteLast: '至少要留一条地区。',
  kernelApplyHint: '启动/重启会用当前设置重新生成配置并应用;失败会自动回滚到直连。',
  routingRegionDescription: '路由器本身在哪。选中的那一条按它自己的规则表逐条匹配(顺序即优先级),没命中的按「其余流量」走。',
  ipv6Title: 'IPv6',
