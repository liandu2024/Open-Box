const en = {
  ...
  backupDescription: 'Bundle everything configured on this router into one file: routing, site sets, node groups, DNS, update plans and, optionally, subscriptions and nodes, client routes and shared network. Import it on a new device and skip the setup.',
