const en = {
  ...
  routeCmpPillIncomplete: 'Incomplete',
  routeCmpPillUnknown: 'Undetermined',
  routeCmpPillFailed: 'Query failed',
  routeCmpReadUp: 'Read upward from “Start” at the bottom',
  routeCmpNotTerminal: 'A panel test is not a measurement of a specific client',
  ...
  routeNeedJoin: ' and ',
  routeRuleMissing: 'Missing {needs}',
  routeRuleUndetermined: 'Rule #{index} depends on {needs}; cannot be decided yet',
  routeRuleWhy: 'Why the prediction stops here',
  routeRuleWhyBody: 'That rule may change the outbound first; without {needs} it cannot be skipped to predict by the later policies.',
  routeRulePending: 'Needs input',
  ...
  routePolicyLabel: 'Entry policy',
  routePolicyDns_none: 'DNS all via original upstream',
  routePolicyDns_domains: 'DNS forwarded by domain',
  routePolicyDns_all: 'DNS fully forwarded to the kernel',
  routePolicyDnsHijack: 'DNS hijacked by firewall',
  routePolicyDnsOff: 'DNS not hijacked',
  routePolicyBypassOn: 'direct sets bypassed at the entry ({via})',
  routePolicyBypassOff: 'direct traffic still enters the kernel',
  routePolicyIpv6_off: 'IPv6 off',
  routePolicyIpv6_node: 'IPv6 handed to the node',
  routePolicyIpv6_ipv4: 'proxied IPv6 downgraded to IPv4',
  routePolicyMore: 'Why',
