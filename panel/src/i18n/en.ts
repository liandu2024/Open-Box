const en = {
  ...
  routingPolicyDefaultLabel: 'Default target',
  routingPolicyDefaultHint: 'Selected on first deploy; changeable any time on the Proxies page.',
  routingPolicyDefaultUnset: 'Not set',
  ...
  routingPolicyConditionHint: 'Comma-separated. Conditions within one policy are OR-ed — any match counts.',
