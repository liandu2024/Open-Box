const en = {
  ...
  routingRegionRulesetsLabel: 'Rule sets',
  routingRegionRulesetsPlaceholder: 'geosite-cn,geoip-cn',
  routingRegionRulesetsHint: 'Comma-separated. Leave empty for no special rules — everything follows "Everything else" below.',
  routingRegionTargetLabel: 'Rule sets go',
  routingRegionFallbackLabel: 'Everything else goes',
  routingRegionViaProxy: 'Through proxy',
  routingRegionSummary: '{rulesets} → {target}, everything else → {fallback}',
