const en = {
  ...
  directTestUrlHint: 'Only for the built-in direct outbound; it measures how far this address is over direct.',
  ...
  dnsRewriteNote: 'Changing a source domain needs a kernel restart; target changes apply within two seconds. *.example.com matches subdomains only, not example.com itself.',
