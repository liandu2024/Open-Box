const en = {
  ...
  backupDescription: 'Bundle everything configured on this router into one file: routing, site sets, node groups, client routes, shared network, DNS, update plans and optionally subscriptions and nodes. Import it on a new device and skip the setup.',
  backupIncludeSubscriptions: 'Include subscriptions and nodes',
  backupExport: 'Export',
  backupExportHint: 'The panel password is not included; browser-side settings such as appearance are exported from Panel settings.',
  backupImport: 'Import',
  backupImportHint: 'Pick an exported .json file; restart the core afterwards to apply.',
