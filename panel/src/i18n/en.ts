const en = {
  ...
  proxiesPendingSiteSets: 'Site set(s) "{names}" are saved, but the kernel is still running the old config. Restart the kernel to see them here.',
  proxiesPendingApply: 'Restart kernel & apply',
  proxiesPendingApplyFailed: 'Kernel restart failed: {detail}',
  proxiesPendingApplied: 'Applied. Kernel restarted.',
  ...
  routingPoliciesDescription: 'A site set is a group of matching rules. Traffic it claims takes the line you pick for it on the Proxies page. Matched in order — drag to reorder; whatever nothing claims goes to the fallback at the bottom. Changes take effect after a kernel restart (the Proxies page reminds you and offers a one-click restart).',
