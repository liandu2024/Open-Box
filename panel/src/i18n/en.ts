const en = {
  ...
  routingCustomOutboundLabel: 'Fixed exit',
  routingCustomOutboundNone: 'Not set (rule inactive)',
  routingCustomOutboundGroups: 'Node groups',
  routingCustomOutboundNodes: 'Nodes',
  routingCustomOutboundMissing: 'gone',
  routingCustomOutboundHint: 'Matching traffic always takes this exit, regardless of what the Proxies page selects. You can pick a single node here; site sets can only pick a node group.',
  routingCustomOutboundRequired: 'Pick a fixed exit first.',
  routingCustomOutboundSummary: 'Fixed exit: {name}',
  routingCustomNoOutbound: 'No fixed exit set (rule inactive)',
