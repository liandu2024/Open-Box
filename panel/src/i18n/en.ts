const en = {
  ...
  routingCategoryDeleteTitle: 'Delete routing rule',
  routingCategoryDeleteConfirm: 'Delete the “{name}” routing rule? Its traffic will then follow the fallback rule.',
  ...
  routingRegionCn: 'Mainland China',
  routingRegionCnHint: 'Chinese sites and IPs go direct (never through Open-Box); everything else is proxied.',
  routingRegionHkmo: 'Hong Kong / Macau',
  routingRegionHkmoHint: 'Only the policies below are proxied; everything else goes direct.',
  routingRegionOther: 'Elsewhere',
  routingRegionOtherHint: 'Chinese sites and IPs are proxied (back to China); everything else goes direct.',
  routingRegionDirectNote: "Direct traffic and its DNS never touch Open-Box — they take the router's original path.",
  ...
  dnsDirectSystemNote: "Direct domains are resolved by the system (the router's own DNS), never through Open-Box.",
  ...
  routingRegionDescription: 'Decides where traffic goes when no policy below claims it.',
