const en = {
  ...
  routingOutboundsEmpty: 'All off — policies can only go direct.',
  routingOutboundReject: 'Reject',
  routingRegionDirectNote: 'Direct traffic and its DNS never touch Open-Box — they take the router\'s original path. Proxied domains resolve through the node that policy is set to.',
  routingPoliciesTitle: 'Site sets',
  routingPoliciesDescription: 'A site set is a group of matching rules. Traffic it claims takes the line you pick for it on the Proxies page. Matched in order — drag to reorder; site sets win over the region rules on the Routing tab.',
  routingPoliciesEmpty: 'No site sets yet. Without them, everything follows the region rules on the Routing tab.',
  ...
  edit: 'Edit',
  routingRegionAdd: 'Add region',
  routingRuleActionHeader: 'Action',
  routingRuleValueHeader: 'Value',
  routingRuleTypeHeader: 'Type',
  routingRegionSummaryRules: '{count} rules, else → {fallback}',
  routingRegionNoRules: 'No rules yet — everything follows "Everything else" below.',
  routingRegionRuleAdd: 'Add rule',
  routingRegionRulesLabel: 'Rules',
  routingRegionSettingsTitle: 'Routing for "{name}"',
  routingRegionNewName: 'New region',
  routingRegionNameLabel: 'Name',
  routingRegionNamePlaceholder: 'e.g. Japan',
  routingRegionNameRequired: 'Give this region a name first.',
  routingRegionFallbackLabel: 'Everything else',
  routingRegionViaProxy: 'Through proxy',
  routingRegionSummaryAll: 'All traffic → {fallback}',
  routingRegionDeleteTitle: 'Delete region',
  routingRegionDeleteConfirm: 'Delete "{name}"?',
  routingRegionDeleteLast: 'Keep at least one region.',
  ...
  routingRegionDescription: 'Where this router is. The selected one matches its rules top to bottom (order is priority); whatever no rule claims follows "Everything else".',
  ipv6Title: 'IPv6',
