const en = {
  ...
  routingPoliciesDescription: 'A site set is a group of matching rules. Traffic it claims takes the line you pick for it on the Proxies page. Matched in order — drag to reorder; whatever nothing claims goes to the fallback at the bottom.',
