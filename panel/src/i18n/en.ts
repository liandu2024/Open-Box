const en = {
  ...
  routeTestFakeIpSub: 'fake-ip',
  routeTestFakeIpIntercepted: 'The query never reached {server}; the far end of the line intercepted it',
  routeTestFakeIpAnswered: 'The far end answered with a fake IP',
  routeTestFakeIpNote: 'Connections to this fake address take the same line; the far end maps it back to the domain and does the real lookup',
