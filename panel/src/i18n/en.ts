const en = {
  ...
  groupAllNodes: 'Include all valid nodes',
  groupAllNodesHint: 'Members then follow every subscription refresh automatically.',
  groupMembersLabel: 'Members',
  groupAvailable: 'Available',
  groupSelected: 'Selected',
  groupClear: 'Clear',
  groupNoSelected: 'Click an item on the left to add it.',
