const en = {
  ...
  // --- Onboarding wizard (P4b Task 4) ---
  wizard: 'Setup wizard',
  wizardLoading: 'Loading…',
  wizardContinue: 'Continue',
  wizardSkip: 'Skip for now',
  wizardStepShortPassword: 'Password',
  wizardStepShortLanguage: 'Language',
  wizardStepShortRegion: 'Region',
  wizardStepShortConfirm: 'Routing',
  wizardStepShortSubscription: 'Subscription',
  wizardPathDevice: 'Your device',
  wizardPathSplit: 'Which way to send it',
  wizardPathDirectTitle: 'Direct',
  wizardPathProxyTitle: 'Through your node',
  wizardPathProxyPendingTitle: 'No node yet',
  wizardPathNodeCount: '{count} nodes',
  wizardStepLanguageTitle: 'Choose your language',
  wizardStepLanguageDescription: 'You can change this anytime in settings.',
  wizardStepRegionTitle: 'Where are you?',
  wizardStepRegionDescription:
    'This decides which sites connect directly and which need to go the long way round.',
  wizardRegionLabel: 'Region',
  wizardRegionOptionCn: 'Mainland China',
  wizardRegionOptionHk: 'Hong Kong',
  wizardRegionOptionTw: 'Taiwan',
  wizardRegionOptionJp: 'Japan',
  wizardRegionOptionKr: 'South Korea',
  wizardRegionOptionSg: 'Singapore',
  wizardRegionOptionUs: 'United States',
  wizardRegionOptionGb: 'United Kingdom',
  wizardRegionOptionDe: 'Germany',
  wizardRegionOptionOther: 'Somewhere else',
  wizardStepConfirmTitle: 'Recommended routing',
  wizardStepConfirmDescription:
  ...
  wizardConfirmProxySummaryProxy: 'Everything else goes through the node you add.',
  wizardConfirmProxySummaryDirect:
    'Everything else connects directly for now — you can send specific sites through your node later.',
  wizardStepSubscriptionTitle: 'Add your subscription',
  wizardStepSubscriptionDescription:
    "A subscription is a link your provider gives you. Paste it in and you're set.",
  wizardSubscriptionNameLabel: 'Name it',
  wizardSubscriptionNamePlaceholder: 'e.g. "My subscription"',
  wizardSubscriptionUrlLabel: 'Subscription link',
  wizardPreview: 'Preview',
  wizardImport: 'Add it',
  wizardSubscriptionSkipLink: 'Skip this step',
  wizardSubscriptionPreviewSummary: 'Found {count} nodes',
  wizardSubscriptionSkippedSummary: '{count} skipped',
  wizardSubscriptionImportFailed: "Couldn't add it: {message}",
  wizardSubscriptionDefaultName: 'Subscription',
  wizardFinishTitle: 'All set',
  wizardFinishDescription: 'This is your traffic path now. You can adjust it anytime in settings.',
  wizardFinishNoSubscriptionNote:
    "You haven't added a node yet, so proxying won't work until you do — direct sites still work fine. Add one anytime.",
  wizardDeployDetailLabel: 'Details',
  wizardDeployNow: 'Deploy now',
  wizardDeploying: 'Deploying…',
  wizardGetStarted: 'Get started',
  wizardDeploySuccess: "Live — you're now using your node.",
  ...
  subscriptionRenameTemplateLabel: 'Naming template',
  subscriptionRenameTokensHint: 'Tokens:',
  ...
  penetrationEmptyHint:
    'Results show up here as a path, the same way the setup wizard shows your traffic route.',
