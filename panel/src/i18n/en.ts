const en = {
  ...
  routingPoliciesTitle: 'Policies',
  routingPoliciesDescription: 'Traffic matching a policy takes the line that policy selects. Policies match in order (drag to reorder) and take precedence over the region rules above.',
  routingPoliciesEmpty: 'No policies yet. Without any, all traffic follows the region rules above.',
  routingPolicyAdd: 'Add policy',
  routingPolicyAddTitle: 'Add policy',
  routingPolicyEditTitle: 'Edit policy',
  routingPolicyNameLabel: 'Policy name',
  routingPolicyRulesLabel: 'Rules',
  routingPolicyRuleAdd: 'Add rule',
  routingPolicyNoRuleYet: 'No rules yet. Add at least one, or this policy never matches anything.',
  ...
  routingPolicyNameRequired: 'A policy name is required.',
  routingPolicyNameDuplicate: 'That name is taken; the policy name becomes the kernel outbound tag and must be unique.',
  ...
  routingPolicyConditionRequired: 'Fill in at least one condition, or the policy can never match.',
