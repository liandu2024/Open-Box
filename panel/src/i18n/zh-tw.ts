...
const zhTW: LANG_MESSAGE = {
  ...
  routingCategoryDeleteTitle: '刪除分流規則',
  routingCategoryDeleteConfirm: '確定刪除「{name}」這條分流規則?刪掉後它會跟著後面的兜底規則走。',
  routingOutboundsTab: '出站',
  routingOutboundsTitle: '策略可以選的出站',
  routingOutboundsDescription: '每條策略在核心裡是一個選擇器,這裡決定它能選到哪幾類東西;具體走哪條線路在「代理」頁點選。',
  routingOutboundsPreview: '策略裡會看到:',
  routingOutboundsEmpty: '一個都沒開,策略只能走直連。',
  routingOutboundReject: '拒絕',
  routingRegionCn: '中國大陸',
  routingRegionCnHint: '中國網站與 IP 直連(不經過 Open-Box),其餘走代理。',
  routingRegionHkmo: '香港澳門',
  routingRegionHkmoHint: '只有下面的策略走代理,其餘全部直連。',
  routingRegionOther: '其他地區',
  routingRegionOtherHint: '中國網站與 IP 走代理(回國),其餘直連。',
  routingRegionDirectNote: '走直連的流量和它的 DNS 都不經過 Open-Box,直接走路由器原來的線路。',
  routingPoliciesTitle: '策略分流',
  routingPoliciesDescription: '命中策略的流量走該策略選中的線路。策略按順序比對,可以拖曳調整;策略優先於上面的地區規則。',
  routingPoliciesEmpty: '還沒有策略。沒有策略時,全部流量按上面的地區規則走。',
  routingPolicyAdd: '新增策略',
  routingPolicyAddTitle: '新增策略',
  routingPolicyEditTitle: '修改策略',
  routingPolicyNameLabel: '策略名稱',
  routingPolicyNamePlaceholder: '比如:谷歌',
  routingPolicyNameRequired: '請填寫策略名稱。',
  routingPolicyNameDuplicate: '已有同名策略;策略名會直接用作核心裡的出站名稱,不能重複。',
  routingPolicyDefaultLabel: '預設走',
  routingPolicyDefaultHint: '首次部署時選中的線路,之後可以在「代理」頁隨時改。',
  routingPolicyDefaultUnset: '未指定',
  ...
  routingPolicyConditionHint: '用英文逗號分隔;同一條策略裡幾類條件是「或」的關係,命中任一條即算命中。',
  routingPolicyConditionRequired: '至少要填一類比對條件,否則這條策略永遠不會命中。',
  ...
  dnsDirectSystemNote: '直連網域交給系統解析(路由器原有的 DNS),不經過 Open-Box。',
  ...
  routingRegionDescription: '路由器本身在哪。它決定沒被下面的策略挑走的流量往哪走。',
