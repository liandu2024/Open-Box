...
const zhTW: LANG_MESSAGE = {
  ...
  testUrlLabel: '測速位址',
  testUrlDescription: '自動擇優(url-test)群組和代理頁的延遲測試用這兩個位址;每個自動擇優群組還可以在出口節點裡單獨指定。',
  trafficRetentionTitle: '分析資料保留時長',
  trafficRetentionDescription: '每日流量的曲線、排行,以及點開後的組成明細,在路由器上存多久。超期的記錄每分鐘清理一次。',
  trafficRetentionUnit: '個月',
  trafficRetentionRange: '1 ~ 36,預設 6',
  ...
  marketName: '安格超市',
  aiRelayLabel: 'AI 中轉站：',
  aiRelaySubscription: '訂閱制',
  aiRelayOnDemand: '按需使用',
  ...
  trafficOtherHint: '面板每 2 秒讀一次核心的連線表,存活不到一個取樣週期的連線歸不到出口節點/網域,只計入當天總量',
  trafficEmptyDay: '這天沒有流量記錄',
  trafficMoreRows: '還有 {n} 條沒顯示,輸入關鍵字縮小範圍',
  trafficPickDay: '點一根柱子看這天按終端設備、出口節點、訪問目標的明細',
