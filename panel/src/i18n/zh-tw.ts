...
const zhTW: LANG_MESSAGE = {
  ...
  routingRegionRulesetsLabel: '規則集',
  routingRegionRulesetsPlaceholder: 'geosite-cn,geoip-cn',
  routingRegionRulesetsHint: '以半形逗號分隔。留空表示這個地區沒有特殊規則,全部流量照下面的「其餘流量」走。',
  routingRegionTargetLabel: '規則集走',
  routingRegionFallbackLabel: '其餘流量走',
  routingRegionViaProxy: '代理',
  routingRegionSummary: '{rulesets} → {target},其餘 → {fallback}',
  ...
  routingRegionDescription: '路由器本身在哪。選中的那一條決定沒被下面的策略挑走的流量往哪走;可以改名、改規則、新增和拖曳排序。',
  ipv6Title: 'IPv6',
