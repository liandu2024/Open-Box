...
const zhTW: LANG_MESSAGE = {
  ...
  testUrlLabel: '測速位址',
  testUrlDescription: '自動擇優(url-test)群組和代理頁的延遲測試用這兩個位址;每個自動擇優群組還可以在出口管理裡單獨指定。',
  ...
  trafficOtherHint: '面板每 2 秒讀一次核心的連線表,存活不到一個取樣週期的連線歸不到出口/網域,只計入當天總量',
  trafficEmptyDay: '這天沒有流量記錄',
  trafficMoreRows: '還有 {n} 條沒顯示,輸入關鍵字縮小範圍',
  trafficPickDay: '點一根柱子看這天按終端設備、出口、訪問目標的明細',
