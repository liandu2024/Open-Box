...
const zhTW: LANG_MESSAGE = {
  ...
  routingRegionDirectNote: '走直連的流量和它的 DNS 都不經過 Open-Box,直接走路由器原來的線路;走代理的網域,由該策略選中的節點解析。',
  routingPoliciesTitle: '站點集',
  routingPoliciesDescription: '一個站點集 = 一組比對規則。命中的流量走這個站點集選中的線路(在「代理」頁選)。按順序比對,可以拖曳調整;站點集優先於「分流」頁的地區規則。',
  routingPoliciesEmpty: '還沒有站點集。沒有站點集時,全部流量照「分流」頁的地區規則走。',
  ...
  edit: '編輯',
  routingRegionAdd: '新增地區',
  routingRuleActionHeader: '動作',
  routingRuleValueHeader: '規則值',
  routingRuleTypeHeader: '類型',
  routingRegionSummaryRules: '{count} 條規則,其餘 → {fallback}',
  routingRegionNoRules: '還沒有規則。全部流量照下面的「其餘流量」走。',
  routingRegionRuleAdd: '新增規則',
  routingRegionRulesLabel: '規則',
  routingRegionSettingsTitle: '「{name}」的分流設定',
  routingRegionNewName: '新地區',
  routingRegionNameLabel: '名稱',
  routingRegionNamePlaceholder: '例如:日本',
  routingRegionNameRequired: '先給這條地區取個名字。',
  routingRegionFallbackLabel: '其餘流量',
  routingRegionViaProxy: '代理',
  routingRegionSummaryAll: '全部流量 → {fallback}',
  routingRegionDeleteTitle: '刪除地區',
  routingRegionDeleteConfirm: '確定刪除「{name}」嗎?',
  routingRegionDeleteLast: '至少要留一條地區。',
  kernelApplyHint: '啟動/重新啟動會用目前設定重新產生設定檔並套用;失敗會自動回復成直連。',
  routingRegionDescription: '路由器本身在哪。選中的那一條按它自己的規則表逐條比對(順序即優先級),沒命中的照「其餘流量」走。',
  ipv6Title: 'IPv6',
