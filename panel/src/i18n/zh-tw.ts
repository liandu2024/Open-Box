...
const zhTW: LANG_MESSAGE = {
  ...
  backupTitle: '匯出與匯入',
  backupDescription: '把這台路由器上配好的東西打成一個檔案:目標分流、站點集、節點組、終端分流、共享網路、DNS、更新計畫等,可選帶上訂閱和節點。新裝置匯入後免設定。',
  backupIncludeSubscriptions: '包含訂閱和節點',
  backupExport: '匯出',
  backupExportHint: '不含面板密碼;面板外觀等瀏覽器端設定在「面板設定」裡另匯。',
  backupImport: '匯入',
  backupImportHint: '選一個匯出的 .json 檔案;匯入後重啟核心生效。',
  ...
  groupIconLabel: '圖示',
  iconScaleLabel: '縮放',
  iconScaleHint: '預設 0 不縮放;+1 加大 1px,-1 縮小 1px',
