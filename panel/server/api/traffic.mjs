...
export const registerTrafficRoutes = (app, { collector, now = () => new Date() }) => {
  ...
  router.get('/traffic/day', (req, res) => {
    ...
    res.json({ day, today: localDay(now()), total, nodes, hosts, hostsCount: Number(hostSum.n) || 0, other })
  })
